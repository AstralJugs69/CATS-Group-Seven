      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <BatchList
              batches={batches}
              onSelectBatch={(batch) => navigate(`/farmer/mint?batchId=${batch.id}`)}
              selectedBatch={null}
              onCreateBatch={() => navigate('/farmer/new-harvest')}
        ...
        <Route
          path="new-harvest"
          element={<HarvestForm onSuccess={() => navigate('/farmer/batches')} />}
        />
        <Route
          path="mint"
